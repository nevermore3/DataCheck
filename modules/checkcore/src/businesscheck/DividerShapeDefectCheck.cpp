...
namespace kd {
    namespace dc {
        ...
        void DividerShapeDefectCheck::getComparePair(shared_ptr<DCDivider> div, int begin, int end, bool nodeDirection,
        ...
        void DividerShapeDefectCheck::checkShapeDefect(string checkModel, double distLimit, shared_ptr<DCDivider> div,
                                                       shared_ptr<DCDividerAttribute> divAtt,
        ...
        void DividerShapeDefectCheck::check_JH_C_1_AND_JH_C_2(shared_ptr<MapDataManager> mapDataManager,
                                                              shared_ptr<CheckErrorOutput> errorOutput) {
        ...
        bool DividerShapeDefectCheck::execute(shared_ptr<MapDataManager> mapDataManager,
                                              shared_ptr<CheckErrorOutput> errorOutput) {
