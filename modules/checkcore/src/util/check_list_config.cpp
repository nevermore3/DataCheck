...
void CheckListConfig::CheckID2CheckDesc() {
    ...
    map<string, string> ID2Desc {
        ...
        {CHECK_ITEM_KXS_ORG_033, DESC_NAME(CHECK_ITEM_KXS_ORG_033)},
        {CHECK_ITEM_KXS_ORG_034, DESC_NAME(CHECK_ITEM_KXS_ORG_034)},
        ...
        {CHECK_ITEM_KXS_ROAD_011, DESC_NAME(CHECK_ITEM_KXS_ROAD_011)},
        {CHECK_ITEM_KXS_ROAD_012, DESC_NAME(CHECK_ITEM_KXS_ROAD_012)},
        {CHECK_ITEM_KXS_ROAD_013, DESC_NAME(CHECK_ITEM_KXS_ROAD_013)},
        {CHECK_ITEM_KXS_ROAD_014, DESC_NAME(CHECK_ITEM_KXS_ROAD_014)},
        {CHECK_ITEM_KXS_ROAD_015, DESC_NAME(CHECK_ITEM_KXS_ROAD_015)},
        {CHECK_ITEM_KXS_ROAD_016, DESC_NAME(CHECK_ITEM_KXS_ROAD_016)},
        {CHECK_ITEM_KXS_ROAD_017, DESC_NAME(CHECK_ITEM_KXS_ROAD_017)},
        {CHECK_ITEM_KXS_ROAD_018, DESC_NAME(CHECK_ITEM_KXS_ROAD_018)},
        {CHECK_ITEM_KXS_ROAD_019, DESC_NAME(CHECK_ITEM_KXS_ROAD_019)},
        {CHECK_ITEM_KXS_ROAD_020, DESC_NAME(CHECK_ITEM_KXS_ROAD_020)},
        {CHECK_ITEM_KXS_ROAD_021, DESC_NAME(CHECK_ITEM_KXS_ROAD_021)},
        ...
        {CHECK_ITEM_KXS_LANE_024, DESC_NAME(CHECK_ITEM_KXS_LANE_024)},
